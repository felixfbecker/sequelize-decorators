...
export function Attribute(options?: string | DataTypes.DataType | ModelAttributeColumnOptions) {
    return function(prototype: Object, name: string): void {
        ...
        if (type && (!options || (typeof options !== 'string' && !((<DataTypes.AbstractDataTypeStatic>options).prototype && (<DataTypes.AbstractDataTypeStatic>options).prototype instanceof DataTypes.ABSTRACT) && !(<ModelAttributeColumnOptions>options).type))) {
            switch (type) {
